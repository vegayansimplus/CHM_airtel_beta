...
import { useGetMopCreateQuery } from "../../api/mopCreateApiSlice";

interface MopCreationPageProps {
  domainId?: number;
  subDomainId?: number;
}
...
export const MopCreationPage: React.FC<MopCreationPageProps> = ({
  domainId,
  subDomainId,
}) => {
