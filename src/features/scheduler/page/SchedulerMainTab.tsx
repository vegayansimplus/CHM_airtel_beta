...
const SchedulerMainTab: React.FC<SchedulerMainTabProps> = ({
  ...
  const activeTab = useMemo(() => {
    ...
    if (path.includes("activityviewandsetup")) {
      return "activityviewandsetup";
    }
  ...
  useEffect(() => {
    switch (activeTab) {
      ...
      case "activityviewandsetup":
        setDynamicHeaderText("Activity View & Setup");
        break;
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* ✅ TAB 2 */}
          <Tab
            label="Activity View & Setup"
            value="activityviewandsetup"
            to="activityviewandsetup"
            component={Link}
          />
        </Tabs>
      </Box>
...
//     if (["crqWorkflow"].includes(lastSegment)) {
//       return lastSegment;
//     }

//     return "crqWorkflow"; // default fallback
//   }, [location.pathname]);
...
//           <Tab
//             label="Shift Scheduler"
//             value="crqWorkflow" //  must match route
//             to="crqWorkflow"   //  must match route
//             component={Link}
//           />
//           <Tab
//             label="Activity View & Setup"
//             value="activityviewandsetup" //  must match route
//             to="activityviewandsetup"   //  must match route
//             component={Link}
//           />
//         </Tabs>
//       </Box>
