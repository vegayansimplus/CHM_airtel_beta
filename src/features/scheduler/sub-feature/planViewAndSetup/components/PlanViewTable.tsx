...
import { PlanEditDialog } from "./PlanEditDialog"; // Adjust path as needed
...
export const PlanViewTable: React.FC<Props> = ({
  ...
  const handleSaveEdit = async (updatedData: PlanViewRow) => {
    ...
    // TODO: Trigger your RTK Query mutation here to save the data
    // Example: await updatePlan(updatedData).unwrap();
    // refetch(); // refresh the table if needed
  };
...
// const StatusBadge: React.FC<{ value: string }> = ({ value }) => {
//   const c = STATUS_COLOR[value] ?? { fg: "#374151", bg: "#f3f4f6", dot: "#9ca3af" };
//   return (
//     <span style={{ ...badge, color: c.fg, backgroundColor: c.bg, gap: 5 }}>
//       <span
//         style={{
...
//     },
//     {
//       // Only fetch once at least subDomain is selected
//       skip: subDomainId === undefined,
//     }
//   );
...
//         size: 100,
//         Cell: ({ cell }) => (
//           <Typography sx={{ fontSize: 12 }}>{cell.getValue<string>()}</Typography>
//         ),
//       },
//       {
//         accessorKey: "layer",
...
//       variant: "outlined",
//       sx: {
//         "& .MuiOutlinedInput-root": { fontSize: 12, borderRadius: 1.5, height: 30 },
//       },
//     },
//     muiLinearProgressProps: { color: "primary", sx: { height: 2 } },
//     muiSkeletonProps: { height: 22, sx: { borderRadius: 1 } },
...
//         }
//       >
//         {(error as any)?.data?.message ?? "Failed to load plans. Please try again."}
//       </Alert>
//     );
//   }
