...
// // ─── EmployeeCell ─────────────────────────────────────────────────────────────
// export function EmployeeCell({ employee, accent }: { employee: Employee; accent?: boolean }) {
//   const theme = useTheme();
//   const initials = employee.name
//     .split(" ")
//     .map((n) => n[0])
...
//           border: "1px solid",
//           borderColor: accent ? alpha(theme.palette.primary.main, 0.2) : "transparent",
//           flexShrink: 0,
//         }}
//       >
//         {initials}
...
// // ─── ShiftBadge ───────────────────────────────────────────────────────────────
// export function ShiftBadge({ code, size = "md" }: { code: ShiftCode; size?: "sm" | "md" }) {
//   const theme = useTheme();
//   return (
//     <Box
//       component="span"
