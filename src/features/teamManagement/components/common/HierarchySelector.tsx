...
//   OrgFilterValues,
// } from "../../../orgHierarchy/types/orgHierarchy.types";
// import { useGetCreateUserDropdownsQuery } from "../../api/teamManagement.api";
...
//   const handleChange = (key: keyof OrgFilterValues, value: number) => {
//     const next = { ...hierarchy, [key]: value };
...
//           fullWidth
//           size="small"
//           value={hierarchy.teamFunction ?? ""}
//           onChange={(e) => handleChange("teamFunction", Number(e.target.value))}
//           disabled={!hierarchy.vertical}
//           error={!!errors.teamFunction}
//           helperText={errors.teamFunction}
//         >
//           {functionOptions.map((opt: any) => (
//             <MenuItem key={opt.value} value={opt.value}>
//               {opt.label}
//             </MenuItem>
//           ))}
...
//           fullWidth
//           size="small"
//           value={hierarchy.subDomain ?? ""}
//           onChange={(e) => handleChange("subDomain", Number(e.target.value))}
//           disabled={!hierarchy.domain}
//           error={!!errors.subDomain}
//           helperText={errors.subDomain}
//         >
//           {subDomainOptions.map((opt: any) => (
//             <MenuItem key={opt.value} value={opt.value}>
//               {opt.label}
//             </MenuItem>
//           ))}
