  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ display: "flex", flexDirection: { xs: "column", lg: "row" }, gap: "14px", alignItems: "flex-start" }}>
        ...
        {/* ══ LEFT — Profile + Work Location + Holidays (existing, preserved) ══ */}
        ...
        {/* ══ RIGHT — remaining width: existing widgets + Reschedule Notification Dashboard ══ */}
        <Box sx={{ flex: 1, minWidth: 0, width: "100%", display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          {/* ── Reschedule Notification Dashboard ── */}
