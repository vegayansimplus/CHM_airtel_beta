...
import {
  Box, IconButton, Typography, List, ListItemButton,
  ListItemIcon, ListItemText, Tooltip, Drawer, Badge,
} from "@mui/material";
...
//  import the hook instead of hardcoding items
...
const SideBar: React.FC<SideBarProps> = ({
  ...
  //   get only the items this user is allowed to see
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IconButton
          ...
          sx={{
            ...
            "&:hover": { bgcolor: "rgba(255,255,255,0.18)", transform: "rotate(90deg)" },
      ...
      {/* NAVIGATION */}
      <List sx={{ px: 1.5, mt: 1 }}>
        {sidebarItems.map(({ to, text, icon, showBadge }) => {
          const active = isActive(to);

          //   only the inbox item gets a Badge — driven by the showBadge flag
...
// // this is my sidebar component give me changes based on your updated logic 
