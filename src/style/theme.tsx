...
/**
 * CHM console design system — light + red.
 * Type ladder: Red Hat Display (headings) / Inter (body) / IBM Plex Mono (codes & numbers).
 */
...
export const cabTheme = createTheme({
  palette: {
    mode: "light",
    primary:    { main: "#d23b3b", contrastText: "#ffffff" },
    secondary:  { main: "#1c2430" },
    background:  { default: "#f4f5f7", paper: "#ffffff" },
    text:        { primary: "#1c2430", secondary: "#5b6470" },
    success:     { main: CAB_STATUS.onTrack },
    warning:     { main: CAB_STATUS.atRisk },
    error:       { main: CAB_STATUS.breached },
    info:        { main: CAB_STATUS.scheduled },
    divider:     "#e3e6ea",
  },
  shape: { borderRadius: 10 },
  typography: {
    fontFamily: 'Inter, system-ui, Arial, sans-serif',
    h4: { fontFamily: '"Red Hat Display", Inter, sans-serif', fontWeight: 700, letterSpacing: "-0.01em" },
    h5: { fontFamily: '"Red Hat Display", Inter, sans-serif', fontWeight: 700, letterSpacing: "-0.01em" },
    h6: { fontFamily: '"Red Hat Display", Inter, sans-serif', fontWeight: 700 },
  ...
  components: {
    MuiPaper: {
      styleOverrides: {
        root: { backgroundImage: "none", border: "1px solid #e3e6ea" },
      },
    },
